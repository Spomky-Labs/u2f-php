...
We recommend to set 20 seconds (20000 milliseconds).
...
$locationExtension = new AuthenticationExtensionsClient('loc', true); // Location of the device required during the creation process
...
$extensions->add(new AuthenticationExtensionsClient('loc', true));
